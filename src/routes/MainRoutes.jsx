...
const ManageCoupons = Loadable(lazy(() => import('views/ManageCoupons')));
const ManageSystemLogs = Loadable(lazy(() => import('views/ManageSystemLogs')));
const ManageAuditLogs = Loadable(lazy(() => import('views/ManageAuditLogs')));
